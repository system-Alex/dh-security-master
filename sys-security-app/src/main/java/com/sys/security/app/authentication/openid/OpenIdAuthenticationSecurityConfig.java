...
public class OpenIdAuthenticationSecurityConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		OpenIdAuthenticationFilter.setAuthenticationSuccessHandler(sysAuthenticationSuccessHandler);
		OpenIdAuthenticationFilter.setAuthenticationFailureHandler(sysAuthenticationFailureHandler);
